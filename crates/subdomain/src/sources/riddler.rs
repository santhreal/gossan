...
#[async_trait]
impl SubdomainSource for Riddler {
    fn name(&self) -> &'static str { "riddler" }
    ...
    async fn query(
        ...
        let url = format!("https://riddler.io/search?q=pld:{}&view=data", domain);
