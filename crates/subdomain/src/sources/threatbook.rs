...
#[async_trait]
impl SubdomainSource for Threatbook {
    fn name(&self) -> &'static str { "threatbook" }
    fn requires_api_key(&self) -> bool { true }
    fn api_key_name(&self) -> &'static str { "THREATBOOK_API_KEY" }
    fn rate_limit(&self) -> SourceRate { SourceRate::per_second(0) }
    fn discovery_source(&self) -> DiscoverySource { DiscoverySource::ThreatBook }
