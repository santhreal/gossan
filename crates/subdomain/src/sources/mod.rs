...
source_mods! {
    alienvault, anubis, ask, asn, baidu, bevigil, binaryedge, bing, bufferover, builtwith, c99, censys, certspotter, chaos, circl, columbus, commoncrawl, crobat, ct, digitorus, dnsdumpster, dnslytics, dnsrepo, duckduckgo, exalead, facebook_ct, farsight_dnsdb, fofa, fullhunt, github, google, greynoise, hackertarget, hackertarget_dns, hunter, intelx, ipinfo, jter, leakix, mnemonic, netlas, omnisint, passivetotal, pastebin, ptrarchive, pugrecon, quake, rapiddns, riddler, robtex, rook, securitytrails, shodan, sitedossier, sonarsearch, spyse, subdomaincenter, sublist3r, synapsint, threatbook, threatcrowd, threatminer, urlscan, viewdns, virustotal, wayback, whoisxml, yahoo, yandex, zone_walk, zoomeye
}
