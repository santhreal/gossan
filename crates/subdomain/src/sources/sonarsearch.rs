...
#[async_trait]
impl SubdomainSource for Sonarsearch {
    fn name(&self) -> &'static str { "sonarsearch" }
    ...
    async fn query(
        ...
        let url = format!("https://opendata.rapid7.com/sonar.fdns_v2/");
