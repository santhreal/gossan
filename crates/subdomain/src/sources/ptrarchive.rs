...
#[async_trait]
impl SubdomainSource for Ptrarchive {
    fn name(&self) -> &'static str { "ptrarchive" }
    ...
    async fn query(
        ...
        let url = format!("https://ptrarchive.com/tools/search.htm?label={}", domain);
