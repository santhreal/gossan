...
#[async_trait]
impl SubdomainSource for Sitedossier {
    fn name(&self) -> &'static str { "sitedossier" }
    ...
    async fn query(
        ...
        let url = format!("http://www.sitedossier.com/parent/{}", domain);
