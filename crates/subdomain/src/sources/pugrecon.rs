...
#[async_trait]
impl SubdomainSource for Pugrecon {
    fn name(&self) -> &'static str { "pugrecon" }
    ...
    async fn query(
        ...
        let url = format!("https://pugrecon.vercel.app/api/subdomains?domain={}", domain);
