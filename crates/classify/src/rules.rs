...
pub fn builtin_rules() -> Vec<ServiceRule> {
    let mut out = vec![
        ...
        ServiceRule {
            ...
            patterns: vec!["Apache/".into(), "Server: Apache".into()],
            version_pattern: Some(r"Apache/(\d+\.\d+\.\d+)".into()),
            security_signals: vec!["server-version-disclosure".into()],
            priority: 10,
        },
        ServiceRule {
            id: "http-nginx".into(),
            ...
            protocol: "tcp".into(),
            common_ports: vec![80, 443, 8080, 8443],
            patterns: vec!["nginx/".into(), "Server: nginx".into()],
        ...
        ServiceRule {
            ...
            patterns: vec!["Microsoft-IIS/".into(), "Server: Microsoft-IIS".into()],
        ...
        ServiceRule {
            ...
            patterns: vec!["SSH-2.0-OpenSSH".into(), "SSH-1.99-OpenSSH".into()],
        ...
        ServiceRule {
            ...
            security_signals: vec!["redis-unauthenticated".into(), "database-exposed".into()],
            priority: 10,
        },
        ServiceRule {
            id: "mongodb".into(),
...
fn extended_rules() -> Vec<ServiceRule> {
    ...
    vec![
        ...
        r(
            ...
            "Apache Tomcat",
            "tcp",
            vec![8080, 8443, 8005, 8009],
            vec!["Apache-Coyote/", "Apache Tomcat"],
            Some(r"Apache Tomcat/?(\d+\.\d+\.\d+)"),
            vec!["servlet-container-exposed", "server-version-disclosure"],
            10,
        ),
        r(
            "http-jetty",
        ...
        r(
            ...
            vec!["debug-server-exposed", "server-version-disclosure"],
            9,
        ),
        r(
            "http-uvicorn",
        ...
        r(
            ...
            "Varnish",
            "tcp",
            vec![80, 443, 6081, 6082],
            vec!["Via: 1.1 varnish", "X-Varnish:"],
            Some(r"varnish\s+v?(\d+\.\d+\.\d+)"),
            vec![],
            7,
        ),
        r(
        ...
        r(
            ...
            vec!["memcached-unauthenticated", "database-exposed"],
            10,
        ),
        r(
            "etcd",
        ...
        r(
            ...
            Some(r"Docker/(\d+\.\d+\.\d+)"),
            vec!["docker-api-exposed", "rce-on-unauth"],
            10,
        ),
        r(
            "kubernetes-api",
        ...
        r(
            ...
            "kubelet",
            "tcp",
            vec![10250, 10255, 10256],
            vec!["/runningpods", "/healthz", "kubelet"],
            None,
            vec!["kubelet-exposed", "rce-on-unauth"],
            10,
        ),
        // ── CI/CD ────────────────────────────────────────────────────
        r(
        ...
        r(
            ...
            "tcp",
            vec![7990, 7999],
            vec!["X-AUSERNAME", "atl_bitbucket_session"],
            None,
            vec!["scm-server-exposed"],
            7,
        ),
        ...
        r(
            ...
            "tcp",
            vec![8080, 80, 443],
            vec!["X-AREQUESTID", "JSESSIONID", "atlassian.xsrf.token"],
            None,
            vec!["issue-tracker-exposed"],
            7,
        ),
        // ── Observability ────────────────────────────────────────────
        r(
        ...
        r(
            ...
            "tcp",
            vec![3100],
            vec!["loki", "/loki/api/v1"],
            Some(r"loki/(\d+\.\d+\.\d+)"),
            vec!["log-server-exposed"],
            7,
        ),
        r(
            "tempo",
            ...
            "tcp",
            vec![3200, 4317, 9411],
            vec!["tempo", "/api/traces"],
            None,
            vec!["trace-server-exposed"],
            6,
        ),
        r(
            "kibana",
        ...
        r(
            ...
            "tcp",
            vec![389, 636],
            vec!["LDAP", "objectClass"],
            None,
            vec!["directory-exposed"],
            8,
        ),
        r(
            "freeradius",
            ...
            vec![1812, 1813],
            vec!["FreeRADIUS"],
            Some(r"FreeRADIUS\s+Version\s+(\d+\.\d+\.\d+)"),
            vec!["radius-exposed"],
            7,
        ),
        // ── Mail (more) ──────────────────────────────────────────────
        ...
        r(
            ...
            vec!["IPMI"],
            None,
            vec!["ipmi-exposed", "remote-mgmt-exposed"],
            10,
        ),
        r(
            "ilo",
        ...
        r(
            ...
            "tcp",
            vec![80, 443],
            vec!["ATEN International", "Supermicro"],
            None,
            vec!["remote-mgmt-exposed"],
            9,
        ),
        ...
        r(
            ...
            vec![53, 8081],
            vec!["PowerDNS"],
            Some(r"PowerDNS\s+Authoritative\s+Server\s+(\d+\.\d+\.\d+)"),
            vec!["dns-version-disclosure"],
            9,
        ),
        r(
            "nsd",
        ...
        r(
            ...
            vec!["RFB 003.", "RFB"],
            Some(r"RFB 003\.(\d+)"),
            vec!["vnc-exposed", "remote-desktop-exposed"],
            9,
        ),
        // ── Game / streaming / chat ──────────────────────────────────
        r(
        ...
        r(
            ...
            None,
            vec!["ics-exposed", "modbus-exposed"],
            10,
        ),
        r(
            "siemens-s7",
        ...
        r(
            ...
            vec![19530, 9091],
            vec!["milvus"],
            Some(r"milvus[/\s](\d+\.\d+\.\d+)"),
            vec!["vector-db-exposed"],
            7,
        ),
        r(
            "qdrant",
        ...
        r(
            ...
            vec!["SMB 1.0"],
            None,
            vec!["smbv1-exposed", "deprecated-protocol"],
            10,
        ),
        r(
            "rsync",
